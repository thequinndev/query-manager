...
export const userNameParameter = queryParameter(
  "name",
  userTableSchema.shape.name,
);
export const userDescriptionParameter = queryParameter(
  "description",
  userTableSchema.shape.description,
);
